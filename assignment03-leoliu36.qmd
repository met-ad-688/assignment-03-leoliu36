...
## Clean EDUCATION_LEVELS_NAME and EMPLOYMENT_TYPE_NAME columns by removing ", \n, and \r characters 
...
# Filter dataset to remove records with missing or zero from SALARY_FROM
...
df1 = filtered_df.select("SALARY_FROM", "NAICS2_NAME", "EMPLOYMENT_TYPE_NAME").toPandas()
